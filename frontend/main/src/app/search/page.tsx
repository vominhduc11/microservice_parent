                            ...
                            {debouncedSearchInput && (
                                ...
                                >
                                    <motion.div variants={itemVariants}>
                                        ...
                                        >
                                            Tìm kiếm cho: <span className="text-white font-medium break-words bg-gradient-to-r from-[#4FC8FF] to-blue-400 bg-clip-text text-transparent">&ldquo;{debouncedSearchInput}&rdquo;</span>
                                        </motion.p>
                                        <motion.p
                        ...
                        {isLoading ? (
                            ...
                            >
                                ...
                                <motion.p
                                    ...
                                    transition={{ delay: 0.3 }}
                                >
                                    Không có kết quả nào cho <span className="break-words text-[#4FC8FF] font-medium">&ldquo;{debouncedSearchInput}&rdquo;</span>.
